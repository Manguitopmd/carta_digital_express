function initCarta() {
    ...
    function showSuggestions(category) {
        ...
        if (category === 'ceviches' || category === 'fuentes') {
            suggestions.push(
                { text: 'Añadir bebida', category: 'bebidas', color: 'bg-green' },
                { text: 'Añadir guarnición', category: 'guarniciones', color: 'bg-accent' },
                { text: 'Ver más ceviches', category: 'ceviches', color: 'bg-mustard' }
            );
        } else if (category === 'entradas') {
            suggestions.push(
                { text: 'Añadir bebida', category: 'bebidas', color: 'bg-green' },
                { text: 'Añadir guarnición', category: 'guarniciones', color: 'bg-accent' },
                { text: 'Ver ceviches', category: 'ceviches', color: 'bg-mustard' }
            );
